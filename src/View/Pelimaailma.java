...
public class Pelimaailma extends JPanel {
	...
	/** Ikkuna, joka sis‰lt‰‰ pelimaailman. */
	...
	/** Kuplan l‰htˆpaikan x-koordinaatti. */
	public static final int LAHTO_X = 250;
	
	/** Kuplan l‰htˆpaikan y-koordinaatti. */
	 ...
	 * @param voitettu true, jos peli on voitettu ja false, jos peli h‰vitty
	 */
