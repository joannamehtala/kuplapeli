...
public class Kupla {
	...
	/**
	 * Kertoo, onko kupla aktiivinen eli onko se liikkeessä.
	...
	public void liiku(){
		//Talla metodilla kupla pitaisi saada liikkumaan suoraan eteenpäin
		//sellaisen vektorin mukaan, jonka suuntaan pelaaja kuplan ampuu 
		//(=eli mihin suuntaan ammus on asteluvun mukaan käännetty).
	...
	public static void main (String[] args){
		...
		if (kupla1.onEhja()){
			System.out.println("Kupla on ehjä.");
		} else {
